...
import { googleSignIn, devSignIn } from "@/lib/auth-actions";
      ...
      <div className="card p-6 space-y-4">
        ...
        {devLogin && (
          <form action={devSignIn} className="space-y-2">
            {hasGoogle && <div className="text-center text-xs text-dim">or, for local testing</div>}
        ...
        {!hasGoogle && !devLogin && (
          <p className="text-sm text-muted">Sign-in is not configured on this deployment. Set <code>GOOGLE_CLIENT_ID</code>/<code>GOOGLE_CLIENT_SECRET</code>, or <code>AUTH_DEV_LOGIN=true</code> for local testing.</p>
        )}
      </div>
